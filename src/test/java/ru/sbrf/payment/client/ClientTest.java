...
class ClientTest {
    ...
    void addAccount() {
        ...
        assert client.getAccountsList().get("0").equals(new AccountCredit("0", Currency.RUB, 999));
        assert client.getAccountsList().get("1").equals(new AccountDebit("1", Currency.RUB, 100));
        assert client.getAccountsList().get("2").equals(new AccountCredit("2", Currency.RUB, 1000));
